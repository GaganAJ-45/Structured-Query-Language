## **Data** 
- Data is nothing but it is a rowfact which describes the property or atttrinutes of an object or entity
...
- It provides security and authentication for users of a particular application.
- stores data in table format.
- Use SQL queries to communicate with the database.
